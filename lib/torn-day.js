...
export function getCalendarDayWindowLabel() {
  return `00:00–23:59 ${TCT_LABEL}`;
}

/** Unix bounds for calendar day in TCT (midnight through 23:59:59). */
export function calendarDayBounds(dateStr) {
  ...
  return {
    ...
    fromTct: `${dateStr} 00:00:00 ${TCT_LABEL}`,
    toTct: `${dateStr} 23:59:59 ${TCT_LABEL}`,
  };
}

/** Current calendar date in TCT (UTC). */
export function getCurrentCalendarDate(now = new Date()) {
